...
import { musicInterface, theme } from "@/types/interface";
function Icons({ theme, music }: musicInterface & theme) {
    ...
    <div>
      <div className="flex items-center flex-col max-sm:ml-6">
        {theme !== "dark" ? (
          ...
          >
            <img
              src="/img/githubPng.png"
              alt="GitHub"
              className="w-[80px] h-[80px] max-sm:w-[50px] max-sm:h-[50px]"
            />
          </a>
        ) : (
          <a
