    ...
    <div className="h-screen w-full bg-light dark:bg-slate-900" id="bg-app">
      ...
      <div className="w-full h-30">
        <div className="pt-5 pl-5">
          <button onClick={handlerChangeTheme} className="bg-transparent text-indigo-300 px-4 py-2 rounded transition-transform transition-filter transform hover:scale-125 hover:text-teal-500">
            Dark Mode. <br/> ⋆⁺₊⋆ ☾⋆⁺₊⋆
          </button>
        </div>
      </div>
